...
const CommandsOrderList: React.FC<ICommandsOrderListProps> = React.memo(({ commands, projectId }) => {
            ...
            {(provided: DroppableProvided) => (
                <div ref={provided.innerRef} {...provided.droppableProps}>
                    {commands.map((command, index) => {
                        return <CommandsOrderListItem command={command} key={command._id} index={index} />;
                    })}
