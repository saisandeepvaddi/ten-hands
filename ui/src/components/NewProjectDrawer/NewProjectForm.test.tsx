...
import { fireEvent, getFakeProjects, render, wait, waitForDomChange } from "../../utils/test-utils";
...
describe.only("NewProjectForm Component", () => {
    ...
    it.skip("renders without crashing", async () => {
        try {
            const { container, getByText } = await render(<NewProjectForm setDrawerOpen={jest.fn()} />);
